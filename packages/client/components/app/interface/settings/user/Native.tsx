    ...
    <Column gap="lg">
      <CategoryButton.Group>
        <CategoryButton
          ...
          description={
            <Trans>Launch NAC when you log into your computer.</Trans>
          }
        >
        ...
        {autostart() &&
          CheckboxButton(
            ...
            t`NAC will start in the system tray.`,
          )}
        {CheckboxButton(
          "minimiseToTray",
          "cancel_presentation",
          t`Minimise to Tray`,
          t`Instead of closing, NAC will hide in your tray.`,
        )}
        {CheckboxButton(
          "customFrame",
          "web_asset",
          t`Custom window frame`,
          t`Let NAC use its own custom titlebar.`,
        )}
      </CategoryButton.Group>
      ...
      <CategoryButton.Group>
        {CheckboxButton(
          ...
          "groups_2",
          t`Discord RPC`,
          t`Rep NAC using Discord rich presence.`,
        )}
        {CheckboxButton(
          "spellchecker",
          "spellcheck",
